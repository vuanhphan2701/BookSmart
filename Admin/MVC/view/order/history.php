...
<?php 
echo $this->getError('alert');
?>
<div class="page-inner">
  <div class="page-header">
    <h4 class="page-title">Orders Cancel</h4>
                  ...
                  <tr data-status="<?= $orderStatus ?>">
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        <a href="<?php echo href('order', 'deletePermanently') ?>&id=<?php echo $order->getId() ?>" class="btn btn-danger btn-sm delete-order-btn" >
