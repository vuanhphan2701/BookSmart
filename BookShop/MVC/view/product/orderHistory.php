  ...
  ?>
  <main class="main">
  <?php echo $this->getError('alertOrder') ?>
    <!--==================== ORDERS LIST ====================-->
    <section
          ...
          foreach ($orders as $order) { ?>
            ...
            <article
              ...
              <header class="order-card__header">
                ...
                <time datetime="2025-02-20" class="order-card__date"><?= $order->getCreatedAt() ?></time>
              </header>
              <div class="order-card__content">
                <p><strong>Total Amount:</strong> $<?= $order->getTotalPrice() ?></p>
                <p>
                  <strong>Status:</strong>
                <span class="status" aria-label="<?= ($order->getOrderStatus() == '1') ? 'Paid' : 'Unpaid' ?>">
              ...
              <footer class="order-card__actions">
                ...
                <a
                  href="<?= href('order', 'delete') ?>&id=<?= $order->getId()?>&status=<?= $order->getOrderStatus() ?>"
