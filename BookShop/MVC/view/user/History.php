...
<<<<<<< HEAD
                            ...
                            <td>
                                <a name="" class="btn btn-primary" role="button" href="<?php echo href('user', 'restore') ?>&id=<?php echo $item->getId() ?>"><i class="fas fa-undo restore-icon"></i>
                                </a>
                                <a class="btn btn-danger" role="button" href="<?php echo href('user', 'deletePermanently') ?>&id=<?php echo $item->getId() ?>"><i class="fa fa-trash search-icon"></i></a>
                            </td>
=======
                            <th>Avatar</th>
                            <th>Username</th>
                            ...
                            <th>Status</th>
                            <th>Actions</th>
>>>>>>> 4ec5a259145c53fb591282af7d1a8ec1701ec6fd
                        </tr>
                    </thead>
                    <tbody>
                        <?php
