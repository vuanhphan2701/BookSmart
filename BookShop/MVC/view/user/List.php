...
<<<<<<< HEAD
                            ...
                            <td>
                                ...
                                <a onclick=" return confirm('Are you sure to delete')" class="btn btn-danger" role="button" href="<?php echo href('user', 'delete') ?>&id=<?php echo $item->getId() ?>"><i class="fa fa-trash search-icon"></i></a>
